					...
					<div class="media-frame-content">
						<ul class="hermit-ul">
							...
							<li class="hermit-li" data-type="tencent">
								...
								<textarea class="hermit-textarea large-text code" cols="30" rows="9" placeholder="输入QQ音乐地址……"></textarea>
							</li>
							<li class="hermit-li" data-type="kugou">
								...
								<textarea class="hermit-textarea large-text code" cols="30" rows="9"	placeholder="直接输入酷狗音乐歌曲/专辑/播放列表ID。如不知道歌曲 ID, 可使用 https://api.lwl12.com/music/kugou/search?output=pre&keyword=歌曲名 进行搜索。将该页面返回结果中 [id] => 后字符串复制至该输入框即可。（PS：[name] => 对应歌名，[artist] => 对应所有歌手名）"></textarea>
							</li>
							<li class="hermit-li" data-type="baidu">
								...
								<textarea class="hermit-textarea large-text code" cols="30" rows="9" placeholder="输入千千音乐地址……"></textarea>
							</li>
						...
						<div>
							...
							<label for="hermit-mode">
								<select id="hermit-mode">
							...
							<label for="hermit-preload">
								<select id="hermit-preload">
